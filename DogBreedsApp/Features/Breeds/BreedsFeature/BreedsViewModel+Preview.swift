...
extension BreedsViewModel {
    ...
    private struct LoadBreedsUsecasePreview: LoadBreedsUsecaseProtocol {
        func execute() async throws -> [BreedsDomain.Breed] {
            let jsonData = """
    ...
    static var preview: BreedsViewModel {
        BreedsViewModel(loadBreedsUsecase: LoadBreedsUsecasePreview())
    }
}
